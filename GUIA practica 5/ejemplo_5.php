...
<body>
<h2>Una asociación de productores de jocote corona tiene como política f
    ijar un precio inicial al kilo de su producto, el cual se clasifica en tipos
    ...
    productor por los jocotes que entrega en un pedido, considerando lo siguient
    e: si es de tipo A, se le cargan $ 0.20 al precio inicial cuando es de tamañ
    o 1; y $ 0.30 si es de tamaño 2. Si es de tipo B, se rebajan $ 0.30 cuando e
    s de tamaño 1, y $ 0.50 cuando es de tamaño 2.
</h2>
<hr>
